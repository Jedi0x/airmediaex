...
Module Name: Bitsclan Theme for Perfex

Description: Bitsclan Theme for Perfex
...
hooks()->add_action('app_admin_footer', 'admin_theme_footer_component');
...

{
    ...
    $CI->app_tabs->add_settings_tab('admin-theme-settings', [
        ...
        'name'     => '' . _l('Enable Dark Theme for clients') . '',
...
function admin_theme_footer_component()
{
        echo '<script src="'.base_url('modules/bitsclan_theme/assets/js/custom.js').'"></script>';
}
