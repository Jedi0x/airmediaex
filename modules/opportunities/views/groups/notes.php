...
<div class="row">
 ...
 <div class="usernote hide">
    <?php echo form_open(admin_url( 'opportunities/add_note/'.$opportunity->id.'/opportunity')); ?>
...
<div class="mtop15">
    <table class="table dt-table scroll-responsive" data-order-col="2" data-order-type="desc">
            ...
            <tr>
                ...
                <div data-note-edit-textarea="<?php echo $note['id']; ?>" class="hide">
                    ...
                    <div class="text-right mtop15">
                      ...
                      <button type="button" class="btn btn-info" onclick="edit_note_opportunity(<?php echo $note['id']; ?>,<?php echo $opportunity->id; ?>);"><?php echo _l('update_note'); ?></button>
                  </div>
              </div>
          </td>
          <td>
        ...
        <td>
            ...
            <a href="<?php echo admin_url('opportunities/delete_opportunity_note/'. $note['id'].'/'.$opportunity->id); ?>" class="btn btn-danger btn-icon _delete"><i class="fa fa-remove"></i></a>
            <?php } ?>
        </td>
    </tr>
    <?php } ?>
