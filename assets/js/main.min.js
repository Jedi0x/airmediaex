...
function calculate_total_group(id='',group_id= '',remove_amount ='') {
    ...
    var calculated_tax,
        ...
        rows = $('.table.has-calculations tbody.item'+group_id+' tr'),
    ...
    $('.total'+group_id).html(format_money(total));
    $('.total'+group_id).attr('data-amount',total);
...
function delete_item(row, itemid , group_id='') {
    $(row).parents('tr').addClass('animated fadeOut', function() {
        ...
        setTimeout(function() {
            ...
            if(group_id != ""){
                calculate_total_group(itemid,group_id,remove_amount);
            }else{
                calculate_total();
            }
        }, 50);
