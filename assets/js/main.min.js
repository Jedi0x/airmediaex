...
function initDataTable(e, t, a, i, n, s) {
    ...
    var p = [10, 25, 50, 100],
        _ = [10, 25, 50, 100];
    (app.options.tables_pagination_limit = parseFloat(app.options.tables_pagination_limit)), -1 == $.inArray(app.options.tables_pagination_limit, p) && (p.push(app.options.tables_pagination_limit), _.push(app.options.tables_pagination_limit)),
        p.sort(function(e, t) {
            return e - t;
        }),
        _.sort(function(e, t) {
    ...
    var m = {
        ...
        initComplete: function(e, t) {
            ...
            s.length && s.attr("colspan", a.find("thead th").length),
                is_mobile() && $(window).width() < 400 && a.find('tbody td:first-child input[type="checkbox"]').length > 0 && (a.DataTable().column(0).visible(!1, !1).columns.adjust(), $("a[data-target*='bulk_actions']").addClass("hide")),
    ...
    if (
        ...
        $.each(v, function() {
            var e = $(this).attr("id");
            $.inArray(e, g) > -1 && u.column("#" + e).visible(!1);
        });
    }
    return (
    ...
    return (
        ...
        .done(function(e) {
            "" !== (e = JSON.parse(e)).message && alert_float("success", e.message),
                ...
                $.fn.DataTable.isDataTable(".table-leads") && table_leads.DataTable().ajax.reload(null, !1);
        })
        .fail(function(e) {
    ...
    void 0 === e && (e = $("body").find("textarea[name='checklist-description']")),
        $.each(e, function() {
            ...
            $(this).outerHeight() < this.scrollHeight + parseFloat($(this).css("borderTopWidth")) + parseFloat($(this).css("borderBottomWidth")) &&
                ($(this).height(0).height(this.scrollHeight), $(this).parents(".checklist").height(this.scrollHeight)),
                "" === e && ($(this).removeAttr("style"), $(this).parents(".checklist").removeAttr("style"));
        });
}
    ...
    return (
        setTimeout(function() {
            ...
            $.post(admin_url + "tasks/update_checklist_item", {
                ...
                t.resolve(), !0 === (n = JSON.parse(n)).can_be_template && e.parents(".checklist").find(".save-checklist-template").removeClass("hide"),
                    "" === a &&
                    $("#checklist-items")
    ...
    if ("" !== t || !n.is(":visible")) {
        if ("" !== a && "0" == t) {
            ...
            return (
                ...
                (s.content += '<div class="form-group"><select id="timer_add_task_id" data-empty-title="' + app.lang.search_tasks + '" data-width="60%" class="ajax-search" data-live-search="true">'),
                (s.content += "</select></div>"),
                ...
                init_ajax_search("tasks", "#timer_add_task_id", void 0, admin_url + "tasks/ajax_search_assign_task_to_timer"), !1
            );
        }
        $(e).addClass("disabled");
        var o = {};
        ...
        if (0 == i || void 0 === i) {
            ...
            if (
                ((a.milestone = o.length ? o.selectpicker("val") : ""),
                    ...
                    "" === a.status && "" === a.priority && "" === a.tags && "" === a.assignees && "" === a.milestone)
            )
                return;
...
function clear_item_preview_values(e) {
    var t = $("table.items tbody").find("tr:last-child").find("select").selectpicker("val"),
        a = $(".main");
        $("#item_select_group").selectpicker("val", ""),
    a.find("textarea").val(""),
        ...
        a.find('input[name="unit"]').val(""),
        a.find('input[name="part_number"]').val(""),
        $('input[name="task_id"]').val(""),
        $('input[name="expense_id"]').val(""),
        $('input[name="discount_group_total"]').val(0),
        $('input[name="discount_group_percent"]').val(0),
        $("table.items tbody").find("tr:first").find(".discount-group-total-type-selected").html("%");
}
        ...
        return (
            get_taxes_dropdown_template(l, e.taxname).done(function(a) {
                ...
                i.length > 0 &&
                    $.each(i, function() {
                        ...
                        if (a.is(":checkbox")) {
                            ...
                            "1" == e.find("[data-fieldid]").attr("data-custom-field-required") && (l = !0),
                            (t = e.html());
                        else if (a.is("select")) {
                ...
                return (
                    ...
                    l && $(".invoice-form").length ?
                    validate_invoice_form() :
                    l && $(".estimate-form").length ?
                    validate_estimate_form() :
                    l && $(".proposal-form").length ?
                    validate_proposal_form() :
                    l && $(".credit-note-form").length && validate_credit_note_form(), !0
                );
            }), !1
        );
    }
        ...
        (t.sortable({
            ...
            $("tbody.connectedSortable").sortable({
                ...
                receive: function(e, t) {
                    var a = $(this).closest("table.invoice-items-table"),
                        i = $("table.invoice-items-table").not(a);
                    $(t.item).find("input.item_group_id").val(a.attr("data-group-id")), calculate_total_group(0, a.attr("data-group-id")), calculate_total_group(0, i.attr("data-group-id"));
                },
            }));
}
...
function add_group_item_to_preview(e) {
    requestGetJSON("invoice_items/get_group_by_id/" + e).done(function(e) {
        clear_item_preview_values(),
            $(".group_items").append(e.template),
            $("select.taxX" + e.group.id).selectpicker(),
            $.each(e.items, function(e, t) {
                var a = [];
                t.taxname && t.taxrate && a.push(t.taxname + "|" + t.taxrate),
                    t.taxname_2 && t.taxrate_2 && a.push(t.taxname_2 + "|" + t.taxrate_2),
                    $(".item" + t.itemid + " select.tax" + t.itemid).selectpicker("val", a),

                    $(".item" + t.itemid + ' input[name="unit"]').val(t.unit);
            }),
            init_selectpicker(),
            calculate_total_group(0, e.group.id),
            init_items_sortable("undefined");
    });
}
...
function get_group_item_preview_values(e) {
    var t = {};
    return (
        (t.description = $(".item" + e + ' .main textarea[name="description"]').val()),
        (t.long_description = $(".item" + e + ' .main textarea[name="long_description"]').val()),
        (t.qty = $(".item" + e + ' .main input[name="quantity"]').val()),
        (t.taxname = $(".item" + e + " .main select.taxX" + e).selectpicker("val")),
        (t.rate = $(".item" + e + ' .main input[name="rate"]').val()),
        (t.part_number = $(".item" + e + ' .main input[name="part_number"]').val()),
        (t.unit = $(".item" + e + ' .main input[name="unit"]').val()),
        $(".item" + e + ' .main input[name="discount_group_percent"]').hasClass("hide") ?
        ((t.discount = $(".item" + e + ' .main input[name="discount_group_total"]').val()), (t.discount_type = "fix")) :
        ((t.discount = $(".item" + e + ' .main input[name="discount_group_percent"]').val()), (t.discount_type = "percentage")),
        t
    );
}

function rand_num() {
    return Math.floor(101 * Math.random() + 1);
}


function add_item_to_group(group_id) {
    var item_id = $(".item-select"+group_id).selectpicker("val");
     e = 'undefined';
       t = 'undefined';
       a = 'undefined';
       i = '';
       n = group_id;
    requestGetJSON('invoice_items/get_item_by_id/' + item_id).done(function(e) {
      
        var s = "",
            o = rand_num();
        (s += '<tr class="sortable item" data-merge-invoice="' + a + '" data-bill-expense="' + i + '">'), (s += '<td class="dragger">'), isNaN(e.qty) && (e.qty = 1), ("" === e.rate || isNaN(e.rate)) && (e.rate = 0);
        var l = 0;
        if ("fix" == e.discount_type) l = e.discount;
        else l = (e.discount / 100) * (e.rate * e.qty);
        var d = e.rate * e.qty - l,
            r = "newitems[" + o + "][taxname][]";
        $("body").append('<div class="dt-loader"></div>');
        var regex = /<br[^>]*>/gi;
        return (
            get_taxes_dropdown_template(r, e.taxname).done(function(a) {
                (s += '<input type="hidden" class="order" name="newitems[' + o + '][order]">'),
                (s += "</td>"),
                (s += '<td class="bold description"><textarea name="newitems[' + o + '][description]" class="form-control" rows="5">' + e.description + "</textarea></td>"),
                (s += '<td><textarea name="newitems[' + o + '][long_description]" class="form-control item_long_description" rows="5">' + e.long_description.replace(regex, "\n") + "</textarea></td>");
                (s += '<td><input type="text" name="newitems[' + o + '][part_number]" value="' + e.part_number + '" class="form-control">');
                var i = $("tr.main td.custom_field"),
                    l = !1;
                i.length > 0 &&
                    $.each(i, function() {
                        ...
                        s += '<td class="custom_field">' + t + "</td>";
                    }),
                    (s += '<td><input type="number" min="0" onblur="calculate_total();" onchange="calculate_total();" data-quantity name="newitems[' + o + '][qty]" value="' + e.qty + '" class="form-control">'),
                    (e.unit && void 0 !== e.unit) || (e.unit = "");
                var r = "",
                    p = "",
                    _ = "",
                    ...
                    f = 0,
                    h = 0;
                "fix" == e.discount_type ? ((r = "selected"), (_ = ""), (p = "shOw"), (u = "$"), (m = "hide"), (f = e.discount)) : ((r = ""), (_ = "selected"), (p = "hide"), (m = "shOw"), (u = "%"), (h = e.discount)),
                    (s += '<input type="hidden" name="newitems[' + o + '][group_id]" value="' + n + '">'),
                    (s += '<input type="text" placeholder="' + app.lang.unit + '" name="newitems[' + o + '][unit]" class="form-control input-transparent text-right" value="' + e.unit + '">'),
                    (s += "</td>"),
                    (s +=
                        '<td class="rate"><input type="number" data-toggle="tooltip" title="' +
                        app.lang.item_field_not_formatted +
                        ...
                        e.rate +
                        '" class="form-control"></td>'),
                    (s += '<td class="taxrate">' + a + "</td>"),
                    (s += '<td class="discount"> <div class="input-group" id="discount-total-' + o + '">'),
                    (s +=
                        '<input type="number" data-discount  class="' +
                        m +
                        '  form-control pull-left input-discount-group-percent" min="0" max="100" name="newitems[' +
                        o +
                        '][discount_group_percent]" data-group-id = "' +
                        n +
                        '" value="0">'),
                    (s +=
                        '<input type="number" data-discount data-toggle="tooltip" data-title="The number in the input field is not formatted while edit/add item and should remain not formatted do not try to format it manually in here." value="' +
                        f +
                        '" class="form-control pull-left input-discount-group-fixed ' +
                        p +
                        ' " min="0" name="newitems[' +
                        o +
                        '][discount_group_total]" data-group-id = "' +
                        n +
                        '">'),
                    (s += '<div class="input-group-addon"><div class="dropdown">'),
                    (s += '<a class="dropdown-toggle" href="#" id="dropdown_menu_tax_total_type_1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">'),
                    (s += '<span class="discount-group-total-type-selected">' + u + '</span><span class="caret"></span>'),
                    (s += "</a>"),
                    (s += '<ul class="dropdown-menu discount-group-total-type-dropdown" id="discount-group-total-type-dropdown' + o + '" aria-labelledby="dropdown_menu_tax_total_type">'),
                    (s += '<li><a href="#" class="discount-group-total-type discount-type-percent ' + _ + '" data-group-id = "' + n + '" data-item-id = "' + o + '">%</a></li>'),
                    (s += '<li><a href="#" class="discount-group-total-type discount-type-fixed ' + r + '" data-group-id = "' + n + '" data-item-id = "' + o + '">$</a></li>'),
                    (s += "</ul>"),
                    (s += "</div>"),
                    (s += "</div>"),
                    (s += "</div>"),
                    (s += "</td>"),
                    (s += '<td class="amount-group" align="right">' + format_money(d, !0) + "</td>"),
                    (s += '<td><a href="#" class="btn btn-danger pull-left" onclick="delete_item(this,' + t + "," + n + '); return false;"><i class="fa fa-trash"></i></a></td>'),
                    (s += "</tr>"),
                    $("table.table-item-group" + n + " tbody").append(s),
                    $(document).trigger({
                        type: "item-added-to-table",
                        data: e,
                        row: s
                    });
                var v = $('input[name="task_id"]').val(),
                    g = $('input[name="expense_id"]').val();
                return (
                    "" !== v &&
                    void 0 !== v &&
                    ((billed_tasks = v.split(",")),
                        $.each(billed_tasks, function(e, t) {
                            $("#billed-tasks").append(hidden_input("billed_tasks[" + o + "][]", t));
                        })),
                    "" !== g &&
                    void 0 !== g &&
                    ((billed_expenses = g.split(",")),
                        $.each(billed_expenses, function(e, t) {
                    ...
                    l && $(".proposal-form").length ?
                    validate_proposal_form() :
                    l && $(".credit-note-form").length && validate_credit_note_form(),

                    $(".item-select"+group_id).selectpicker("val", ""),
                    setTimeout(function() {
                        calculate_total_group(0, n);
                    }, 25), !0
                );
            }), !1
        );
...
function add_group_item_to_table(e, t, a, i, n) {
    if ("" !== (e = void 0 === e || "undefined" == e ? get_group_item_preview_values(n) : e).description || "" !== e.long_description || "" !== e.rate) {
        var s = "",
            o = rand_num();
        (s += '<tr class="sortable item" data-merge-invoice="' + a + '" data-bill-expense="' + i + '">'), (s += '<td class="dragger">'), isNaN(e.qty) && (e.qty = 1), ("" === e.rate || isNaN(e.rate)) && (e.rate = 0);
        var l = 0;
        ...
        return (
            get_taxes_dropdown_template(r, e.taxname).done(function(a) {
                ...
                (s += "</td>"),
                (s += '<td class="bold description"><textarea name="newitems[' + o + '][description]" class="form-control" rows="5">' + e.description + "</textarea></td>"),
                (s += '<td><textarea name="newitems[' + o + '][long_description]" class="form-control item_long_description" rows="5">' + e.long_description.replace(c, "\n") + "</textarea></td>");
                (s += '<td><input type="text" name="newitems[' + o + '][part_number]" value="' + e.part_number + '" class="form-control">');
                var i = $("tr.main td.custom_field"),
                    l = !1;
                i.length > 0 &&
...
function delete_item_group(e) {
    setTimeout(function() {
            $(".item-group-" + e).remove();
        }, 50),
        setTimeout(function() {
            calculate_total_group(0, e);
        }, 50),
        $(".item-group-" + e + " .itemid").each(function() {
            $('input[name="isedit"]').length > 0 && $("#removed-items").append(hidden_input("removed_items[]", $(this).val()));
        });
}
...
// new code here
function calculate_total_group(item="",group="") {
    ...
    var calculated_tax,
        ...
        total = 0,
        quantity = 1,
        custom_discount_added = 0,
        total_discount_calculated = 0,
        rows = $(".group_items tbody tr"),
        ...
        //new code here
        total_discount = $('select[name="discount_added"]').val(),
    ...
    $.each(rows, function() {
        ...
        if ($(this).find("td.rate input").val() !== undefined && $(this).find("td.discount input.shOw").val() !== undefined) {
            var item_rate = $(this).find("td.rate input").val() * quantity;
            var item_discount = $(this).find("td.discount input.shOw").val();


            amount_total += $(this).find("td.rate input").val() * quantity;

            if($(this).find("td.discount input.shOw").hasClass("input-discount-group-fixed")){
                // fix discount
                var discount_price = item_discount;
            }else{
                //percentage discount
                var discount_price = (item_discount / 100) * item_rate;
            }


            group_total = accounting.toFixed( $(this).find("td.rate input").val() * quantity - parseFloat(discount_price), app.options.decimal_places);
            group_total = parseFloat(group_total);

            // row total
            $(this).find("td.amount-group").html(format_money(group_total, true));
            
 
            subtotal += group_total;

            _subtotal += group_total; 
    ...
    if (group != "") {
        ...
        $(".item" + group + " tr").each(function() {
            ...
            if ($(this).find("td.rate input").val() !== undefined && $(this).find("td.discount input.shOw").val() !== undefined) {
                ...
                group_total = parseFloat(group_total);
                $(this).find("td.amount-group").html(format_money(group_total, true));
                sub_total += group_total;
               
            }   

        });
        $(".total" + group).attr("data-amount", sub_total),
        $(".total" + group).html(format_money(sub_total));
    ...
    // if(total_discount == 1){
    //     custom_discount_added = (5 / 100) * _subtotal;
    // }else if(total_discount == 2){
    //     custom_discount_added = (10 / 100) * _subtotal;
    // }else if(total_discount == 3){
    //     custom_discount_added = (25 / 100) * _subtotal;
    // }else if(total_discount == 4){
    //     custom_discount_added = (25 / 100) * _subtotal;
    // }else if(total_discount == 5){
    //     custom_discount_added = (30 / 100) * _subtotal;
    // }else if(total_discount == 6){
    //     custom_discount_added = (40 / 100) * _subtotal;
    // }

    // new feilds added
    $('.new-discount-total').html('-'+format_money(custom_discount_added) + hidden_input('total_amount', accounting.toFixed(amount_total, app.options.decimal_places)) + hidden_input('custom_discount_added', accounting.toFixed(custom_discount_added, app.options.decimal_places)));
    ...
    total = parseFloat(total) + parseFloat(subtotal) - parseFloat(custom_discount_added);
    ...
    if (!isNaN(adjustment)) {
        total = parseFloat(total) + parseFloat(adjustment);
    }
    ...
    $('.discount-total-group').html(discount_html);
    $('.adjustment-group').html(format_money(adjustment));


    

    $('.subtotal-group-invoice').html(format_money(subtotal) + hidden_input('subtotal', accounting.toFixed(subtotal, app.options.decimal_places)));
    $('.total-group-invoice').html(format_money(total) + hidden_input('before_adding_shipping', accounting.toFixed(total-shipping, app.options.decimal_places)) + hidden_input('total', accounting.toFixed(total, app.options.decimal_places)));
...
function calculate_total() {
    ...
    $(".tax-area").remove(),
        ...
        (m = parseFloat(m)),
        isNaN(m) || (d += m);
    var g = "-" + format_money(c);
    $('input[name="discount_total"]').val(accounting.toFixed(c, app.options.decimal_places));
    var b = $('input[name="shipping"]').val();
    isNaN(b) || ((b = parseFloat(b)), (d = b + d)),
        $(".discount-total").html(g),
        ...
        $(".total-group").html(format_money(d) + hidden_input("total", accounting.toFixed(d, app.options.decimal_places))),
        $(".subtotal-group").html(format_money(l) + hidden_input("subtotal", accounting.toFixed(l, app.options.decimal_places))),
        $(document).trigger("sales-total-calculated");
}
...
function delete_item(e, t, a = "") {
    $(e)
        ...
        .addClass("animated fadeOut", function() {
            $(this).find("td.rate input").val();
            setTimeout(function() {
                $(e).parents("tr").remove(), "" == a ? calculate_total() : calculate_total_group(t, a);
            }, 50);
        }),
...
function init_currency(e) {
    ...
    (t.length || e) &&
    requestGetJSON("misc/get_currency/" + (e || t.find('select[name="currency"]').val())).done(function(e) {
...
function merge_field_format_url(e, t, a, i) {
    return e.indexOf("{") > -1 && e.indexOf("}") > -1 ? (e = "{" + e.split("{")[1]) : e.indexOf("%7B") > -1 && e.indexOf("%7D") > -1 && (e = "{" + e.replace("%7B", "").replace("%7D", "") + "}"), e;
}
...
$("body").on("loaded.bs.select change", "select.ajax-search", function(e) {
    ...
    $(function() {
        ...
        $("body").on("change", 'select[name="tax"]', function() {
            ...
            $("body").on("change blur", ".apply-credits-to-invoice .apply-credits-field", function() {
                ...
                $.each(t, function() {
                    ...
                    }).html(app.lang.credit_amount_bigger_then_credit_note_remaining_credits)), e.find('[type="submit"]').prop("disabled", !0)) :
            ...
            $("body").on("change blur", ".apply-credits-from-invoice .apply-credits-field", function() {
                ...
                $.each(t, function() {
                    ...
                    ($(".credits-table").before($("<div/>", {
                        id: "credits-alert",
                        class: "alert alert-danger"
                    }).html(app.lang.credit_amount_bigger_then_invoice_balance)), e.find('[type="submit"]').prop("disabled", !0)) :
        ...
        if ((table_leads = $("table.table-leads")).length) {
            ...
            c.length > 0 && (p.push(c.index()), _.push(c.index())),
        ...
        if ((table_tasks = $(".table-tasks")).length) {
            ...
            $("body").hasClass("tasks-page") && (b += "?bulk_actions=true"),
                (_table_api = initDataTable(table_tasks, b, g, g, v, [table_tasks.find("th.duedate").index(), "asc"])),
        ...
        $("body").on("submit", "._transaction_form", function() {
                ...
                return t.find('[name="description"]').length && t.find('[name="description"]').val().trim().length > 0 && t.find('[name="rate"]').val().trim().length > 0 ?
                    ...
                    (e.before('<div class="alert alert-warning mbot20" id="items-warning">' + app.lang.no_items_warning + "</div>"), $("html,body").animate({
                        scrollTop: $("#items-warning").offset().top
                    }), !1) :
                    (reorder_items(),
                        ...
                        $(this).find(".transaction-submit").prop("disabled", !0), !0);
            }),
            ...
            $("body").on("change", 'input[name="shipping"]', function() {
                var e = parseFloat($('input[name="shipping"]').val()),
                    t = parseFloat($('input[name="total"]').val());
                (t = parseFloat(t + e)), $(".shipping").html(format_money(e)), $(".total").html(format_money(t) + hidden_input("total", accounting.toFixed(t, app.options.decimal_places)));
            }),
            $("body").on("change", 'input[name="shipping_active"]', function() {
                $(this).prop("checked") ? $(".shipping_box").removeClass("hide") : $(".shipping_box").addClass("hide");
            }),
            $("body").on("change", 'input[name="payment_terms_active"]', function() {
                $(this).prop("checked") ? $(".payment_terms_box").removeClass("hide") : $(".payment_terms_box").addClass("hide");
            }),
            $("body").on("change", 'input[name="labour_terms_active"]', function() {
                $(this).prop("checked") ? $(".labour_terms_box").removeClass("hide") : $(".labour_terms_box").addClass("hide");
            }),
            $("body").on("change", 'input[name="term_and_conditions_active"]', function() {
                $(this).prop("checked") ? $(".term_and_conditions_box").removeClass("hide") : $(".term_and_conditions_box").addClass("hide");
            }),
            ...
            $("body").on("click", ".discount-group-total-type", function(e) {

                e.preventDefault();
                var t = $(this).attr("data-item-id");
                $("#discount-group-total-type-dropdown" + t)
                    .find(".discount-group-total-type")
                    .removeClass("selected"),
                    $(this).addClass("selected"),
                    $("#discount-total-" + t + " .discount-group-total-type-selected").html($(this).text()),
                    $(this).hasClass("discount-type-percent") ?
                    ($("#discount-total-" + t + " .input-discount-group-fixed")
                        .addClass("hide")
                        .val(0),
                        $("#discount-total-" + t + " .input-discount-group-percent").removeClass("hide"),
                        $("#discount-total-" + t + " .input-discount-group-percent").addClass("shOw"),
                        $("#discount-total-" + t + " .input-discount-group-fixed").removeClass("shOw")) :
                    ($("#discount-total-" + t + " .input-discount-group-fixed").removeClass("hide"),
                        $("#discount-total-" + t + " .input-discount-group-fixed").addClass("shOw"),
                        $("#discount-total-" + t + " .input-discount-group-percent")
                        .addClass("hide")
                        .val(0),
                        $("#discount-total-" + t + " .input-discount-group-percent").removeClass("shOw"),
                        $("#discount_percent-error", this).remove());
            }),
            $("body").on("change", "td.discount input", function() {
                !0 === $(this).valid() && calculate_total_group(0, $(this).attr("data-group-id"));
            }),
            $("body").on("keyup", "td.discount input", function() {
                !0 === $(this).valid() && calculate_total_group(0, $(this).attr("data-group-id"));
            }),
            $("body").on("onblur", "td.discount input", function() {
                !0 === $(this).valid() && calculate_total_group(0, $(this).attr("data-group-id"));
            }),

            //new code here

            $("body").on("change", 'select[name="discount_added"]', function() {

                calculate_total_group(0,'');
            ...
            $("body").on("change", '.f_client_id select[name="clientid"]', function() {
                ...
                requestGetJSON("invoices/client_change_data/" + e + "/" + (n = void 0 === n ? "" : n)).done(function(e) {
                    ...
                    0 != (o = parseInt(o)) ? l.val(o) : l.val(l.data("base")),
                        _init_tasks_billable_select(e.billable_tasks, t.selectpicker("val")), !0 === e.customer_has_projects ? i.removeClass("hide") : i.addClass("hide"),
                        l.selectpicker("refresh"),
                        init_currency();
                         $(".contact_name").html(e.contact_name);
                });
            }),
            ...
            $(this)
                ...
                .each(function(e) {
                    $(this)
                        .find("td")
                        .last()
                        .append(hidden_input("group_order[" + $(this).attr("data-group-id") + "]", e + 1));
                });
        },
    }),
    setTimeout(function() {
        $(".group_items-drag").sortable({
            update: function(e, t) {
                $(this)
                    .children()
                    .each(function(e) {
                        var t = $(this).attr("data-invoice-id"),
                            a = $(this).attr("data-group-id"),
                            d_type = $(this).attr("data-type"),
                            i = e + 1;
                        $.ajax({
                            type: "POST",
                            url: admin_url + "invoices/rearrange_order",
                            data: {
                                invoice_id: t,
                                group_id: a,
                                order: i,
