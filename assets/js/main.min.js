        ...
        return (
            get_taxes_dropdown_template(r, e.taxname).done(function(a) {
                ...
                var r = "",
                    ...
                    f = 0,
                    h = 0;
                "fix" == e.discount_type ? ((r = "selected"), (_ = ""), (p = "shOw"), (u = "Fixed Amount"), (m = "hide"), (f = e.discount)) : ((r = ""), (_ = "selected"), (p = "hide"), (m = "shOw"), (u = "%"), (h = e.discount)),
                    ...
                    (s += '<li><a href="#" class="discount-group-total-type discount-type-fixed ' + r + '" data-group-id = "' + n + '" data-item-id = "' + o + '">Fixed Amount</a></li>'),
                    (s += "</ul>"),
                    (s += "</div>"),
                    (s += "</div>"),
                    (s += "</div>"),
...
function calculate_total_group(item="",group="") {
    ...
    if(total_discount == 1){
        new_added_discount = (5 / 100) * _subtotal;
    }else if(total_discount == 2){
        new_added_discount = (10 / 100) * _subtotal;
    }else if(total_discount == 3){
        new_added_discount = (25 / 100) * _subtotal;
    }else if(total_discount == 4){
        new_added_discount = (25 / 100) * _subtotal;
    }else if(total_discount == 5){
        new_added_discount = (30 / 100) * _subtotal;
    }else if(total_discount == 6){
        new_added_discount = (40 / 100) * _subtotal;
    }
    

    $(".new-discount-total").html('-'+format_money(new_added_discount));
    ...
    total = parseFloat(total) + parseFloat(subtotal) - parseFloat(new_added_discount);
    ...
    $('.subtotal-group').html(format_money(subtotal) + hidden_input('subtotal', accounting.toFixed(subtotal, app.options.decimal_places)));
    $('.total-group').html(format_money(total) + hidden_input('total', accounting.toFixed(total, app.options.decimal_places)));
