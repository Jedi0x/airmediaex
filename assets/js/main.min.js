...
function get_group_item_preview_values(id) {
    ...
    response.discount = $('.item'+id+' .main input[name="discount"]').val();
    return response;
}
...
function add_group_item_to_table(data, itemid, merge_invoice, bill_expense,group_id) {
    ...
    if (data.description === "" && data.long_description === "" && data.rate === "") { return; }
    var table_row = '';
    //var item_key = $("body").find('tbody .item'+group_id).length + 1;
    ...
    get_taxes_dropdown_template(tax_name, data.taxname).done(function(tax_dropdown) {
        ...
        table_row += '<td class="discount"><input type="number" onblur="calculate_total();" onchange="calculate_total();" data-discount name="newitems[' + item_key + '][discount]" value="' + data.discount + '" class="form-control"></td>';
...
function calculate_total_group(itemid='',groupid='') {
    ...
    $.each(rows, function() {
        ...
        var total_amount_ = $(this).find('td.rate input').val() * quantity;
        var discounted_value = (discount / 100) * total_amount_ ;
        ...
        setTimeout(function() {
            ...
            $('.item'+groupid+' tr').each(function() {
                ...
                _amount = parseFloat(_amount);
                 ...
                 if(!isNaN(total_amount_)){
                    group_sub_total+=parseFloat(total_amount_) - parseFloat(discounted_value);
                 }
