...
class Expenses_model extends App_Model
{
    ...
    public function add($data)
    {
        ...
        if(isset($data['opportunity']) && $data['opportunity'] != ""){
            ...
            $this->db->where('id',$data['opportunity']);
            $res = $this->db->get()->row();
            $data['clientid'] = $res->account;
        }
        ...
        if ($insert_id) {
            ...
            hooks()->do_action('after_expense_added_activity', $data);
            // Bitsclan Solutions End Code
    ...
    public function update($data, $id)
    {
        ...
        $data['id'] = $id;
        hooks()->do_action('after_expense_updated_activity', $data);
