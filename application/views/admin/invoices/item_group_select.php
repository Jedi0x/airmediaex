...
<div class="form-group mbot25 items-wrapper select-placeholder<?php if(has_permission('items','','create')){ echo ' input-group-select'; } ?>">
  <div class="<?php if(has_permission('items','','create')){ echo 'input-group input-group-select'; } ?>">
    <div class="items-select-wrapper">
     <select name="item_select_group" class="selectpicker no-margin<?php if($ajaxItems == true){echo ' ajax-search';} ?><?php if(has_permission('items','','create')){ echo ' _select_input_group'; } ?>" data-width="100%" id="item_select_group" data-none-selected-text="<?php echo _l('add_item_group'); ?>" data-live-search="true">
      <option value=""></option>
 ...
 <div class="input-group-addon">
   <a href="#" data-toggle="modal" data-target="#sale_group">
