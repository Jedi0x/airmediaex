...
foreach ($rResult as $aRow) {
    ...
    // Bitsclan Solutions Start Code 
    elseif ($aRow['rel_type'] == 'opportunity') {
        $toOutput = '<a href="' . admin_url('opportunities/opportunity/' . $aRow['rel_id']) . '" target="_blank" data-toggle="tooltip" data-title="' . _l('opportunity') . '">' . $aRow['proposal_to'] . '</a>';
    }
    // Bitsclan Solutions End Code
