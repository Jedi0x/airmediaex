                     ...
                     <div class="col-md-6 border-right">
                        ...
                        <div class="form-group select-placeholder">
                           ...
                           <select name="rel_type" id="rel_type" class="selectpicker" data-width="100%" data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>">
                              ...
                              <option value="opportunity" <?php if((isset($proposal) &&  $proposal->rel_type == 'opportunity') || $this->input->get('rel_type')){if($rel_type == 'opportunity'){echo 'selected';}} ?>><?php echo _l('proposal_for_opportunity'); ?></option>
