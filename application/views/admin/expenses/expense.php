               ...
               <div class="panel-body">
                  ...
                  <?php echo render_input('amount','expense_add_edit_amount',$value,'number');
                    ...
                    // Bitsclan Solutions Start Code 
                     if((isset($expense) && ($expense->billable == 1 || $expense->clientid != 0)) || isset($customer_id) || isset($opportunity_id)){
                 ...
                 <?php if(isset($opportunity_id)){ ?>
                  <div class="form-group select-placeholder">
                     <label for="opportunity_id" class="control-label"><?php echo _l('expense_add_edit_opportunity'); ?></label>
                     <select id="opportunity_id" name="opportunity" data-live-search="true" data-width="100%" class="ajax-search selectpicker" data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>">
                     <?php $selected = (isset($expense) ? $expense->opportunity : '');
                        if($selected == ''){
                    ...
                    <select class="selectpicker" id= "contacts" data-toggle="" name="opportunity" data-live-search="true" data-width="100%"  data-title="<?php echo _l('expense_add_edit_customer_opportunities'); ?>">
                      ...
                      if(isset($customer_opportunities)){
                       foreach ($customer_opportunities as $k => $v) { ?>
                        <option value = '<?=$v['id']?>' <?php echo ($v['id'] == $expense->opportunity) ? "selected" : "" ;?> > <?=$v['project_name'];?></option> <?php
                      }
                    } 
                    ?>
                    </select>
                ...
                <?php } ?>
                  ...
                  <?php $hide_project_selector = ' hide';
                     ...
                     if((isset($expense) && $expense->clientid != 0) || isset($customer_id) || isset($opportunity_id)){
