...
class Expenses extends AdminController
{
    ...
    public function expense($id = '')
    {
        ...
        if($id != ""){
            $data['customer_opportunities'] =  get_customer_opportunities($data['expense']->clientid);
        }
    ...
    public function delete($id)
    {
        ...
        $this->db->where('id',$id);
        $res = $this->db->get()->row();
        $data['opportunity'] = $res->opportunity;
        $data['id'] = $id;
        
        $response = $this->expenses_model->delete($id);
        hooks()->do_action('after_expense_delete_activity', $data);
        // Bitsclan Solutions End Code
