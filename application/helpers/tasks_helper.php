...
function init_relation_tasks_table($table_attributes = [])
{
    ...
    elseif ($table_attributes['data-new-rel-type'] == 'opportunity') {
        ...
        echo '<div class="checkbox checkbox-inline mbot25">
        <input type="checkbox" checked value="opportunity" disabled id="ts_rel_to_opportunity" name="tasks_related_to[]">
        <label for="ts_rel_to_opportunity">' . _l('proposal_for_opportunity') . '</label>
        </div>';
